...
- Kids are 11, 8, 4 and 2. The Southwest Florida family has the 11- and 8-year-olds. The Gig Harbor (Washington) family has the 4- and 2-year-old, so the toddler car seats and the longest flights belong to the same household. Two car seats and a booster travel with them.
- Seven nights in June 2027, Saturday to Saturday. Must be booked by 30 September 2026.
- HARD REQUIREMENT, the sleeping plan: seven real, enclosed bedrooms with real beds. Five are COUPLE ROOMS (five couples, each sharing a bed): each needs a king, a queen, or two full beds. Two are KIDS' ROOMS: one for the Florida kids (11 and 8: bunks, twins or a shared queen all work) and one for the Washington kids (4 and 2: a room near their parents' room matters more than bed size; a crib or pack-n-play plus a twin or bunk is ideal, and top bunks are unsafe for them): bunk beds are fine there, and two kids sharing one bed need at least a queen. So one or two bunk-bed bedrooms are welcome and count toward the seven. Lofts, open sleeping nooks and pull-out couches do not count as bedrooms. Extra bedrooms beyond seven are margin, not waste.
